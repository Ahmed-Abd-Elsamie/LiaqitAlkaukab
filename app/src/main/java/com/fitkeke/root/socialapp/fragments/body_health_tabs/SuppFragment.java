...
public class SuppFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_supp, container, false);
        context = getActivity();
        initViews(view);
        //..........................................
        GetArticle getArticle = new GetArticle(context, mRecyclerView, "supp");
    ...
    private void initViews(View v) {
        mRecyclerView = v.findViewById(R.id.main_screen_recycler3);
