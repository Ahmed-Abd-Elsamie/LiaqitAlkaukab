...
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_ALIAF;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_FATS;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_FRI;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_IS_ENABLED;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_LABEL;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_MON;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_MYSCORE;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_PROTIN;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_SAT;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_SUN;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_THURS;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_TIME;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_TOTALSCORE;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_TUES;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper.COL_WED;
import static com.fitkeke.root.socialapp.utilities.DatabaseHelper._ID;
...
public final class AlarmUtils {
    ...
    public static ContentValues toContentValues(Alarm alarm) {
        ...
        cv.put(COL_PROTIN, alarm.getProtin());
        cv.put(COL_FATS, alarm.getFats());
        cv.put(COL_ALIAF, alarm.getAliaf());
        cv.put(COL_MYSCORE, alarm.getMyscore());
        cv.put(COL_TOTALSCORE, alarm.getTotalscore());
    ...
    public static ArrayList<Alarm> buildAlarmList(Cursor c) {
        ...
        if (c.moveToFirst()){
            do {
                ...
                final String protin = c.getString(c.getColumnIndex(COL_PROTIN));
                final String fats = c.getString(c.getColumnIndex(COL_FATS));
                final String aliaf = c.getString(c.getColumnIndex(COL_ALIAF));
                final String myscore = c.getString(c.getColumnIndex(COL_MYSCORE));
                final String totalscore = c.getString(c.getColumnIndex(COL_TOTALSCORE));
                ...
                final Alarm alarm = new Alarm(id, time, label, protin, fats, aliaf, myscore, totalscore);
