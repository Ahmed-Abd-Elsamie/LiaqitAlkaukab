...
public final class AddEditAlarmFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        carb = (EditText) v.findViewById(R.id.edit_alarm_label);
        protin = (EditText) v.findViewById(R.id.edit_alarm_protin);
        fats = (EditText) v.findViewById(R.id.edit_alarm_fats);
        aliaf = (EditText) v.findViewById(R.id.edit_alarm_aliaf);
