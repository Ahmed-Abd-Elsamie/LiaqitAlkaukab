package com.fitkeke.root.socialapp.services;
...
public final class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        builder.setContentText("تذكير لتناول وجبتك");
        builder.setTicker("تذكير لتناول وجبتك");
        builder.setVibrate(new long[] {1000,500,1000,500,1000,500});
        builder.setSound(Uri.parse("android.resource://" + context.getPackageName() + "/" + R.raw.eat));
